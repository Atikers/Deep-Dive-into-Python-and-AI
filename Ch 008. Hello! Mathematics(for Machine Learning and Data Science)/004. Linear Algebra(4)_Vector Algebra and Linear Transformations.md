...
$$\underbrace{\begin{pmatrix} \cdot & \cdot & \cdot \\
\cdot & \cdot & \cdot \\
\cdot & \cdot & \cdot \\
\cdot & \cdot & \cdot \end{pmatrix}}_{\text{4}\times\text{3}} \underbrace{\begin{pmatrix} \cdot \\
\cdot \\ \cdot \end{pmatrix}}_{\text{3}\times\text{1}} = \underbrace{\begin{pmatrix} \cdot \\
\cdot \\
\cdot \\
\cdot \end{pmatrix}}_{\text{4}\times\text{1}}$$
