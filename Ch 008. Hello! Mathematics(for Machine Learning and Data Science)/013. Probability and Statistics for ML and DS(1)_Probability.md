...
$$
P(\text{lottery} \& \text{winning} | \text{spam}) = P(\text{lottery} | \text{spam}) \times P(\text{winning} | \text{spam})
$$
...
$$
P(\text{spam} | \text{lottery} \& \text{winning}) = \frac{0.2 \times 0.7 \times 0.75}{(0.2 \times 0.7 \times 0.75) + (0.8 \times 0.125 \times 0.1)}
$$  
