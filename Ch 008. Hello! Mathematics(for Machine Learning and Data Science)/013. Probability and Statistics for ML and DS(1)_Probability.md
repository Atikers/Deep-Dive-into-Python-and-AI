...
$$
P(\text{lottery} \text{ \& } \text{winning} \mid \text{spam})
...
$$
P(\text{spam} | \text{lottery} \text{ \& } \text{winning}) = \frac{P(\text{spam}) \times P(\text{lottery} \text{ \& } \text{winning} | \text{spam})}{P(\text{spam}) \times P(\text{lottery} \text{ \& } \text{winning} | \text{spam}) + P(\text{ham}) \times P(\text{lottery} \text{ \& } \text{winning} | \text{ham})} 
$$  
...
$$
P(\text{spam} | \text{lottery} \text{ \& } \text{winning}) = \frac{0.2 \times 0.7 \times 0.75}{(0.2 \times 0.7 \times 0.75) + (0.8 \times 0.125 \times 0.1)}
$$  
