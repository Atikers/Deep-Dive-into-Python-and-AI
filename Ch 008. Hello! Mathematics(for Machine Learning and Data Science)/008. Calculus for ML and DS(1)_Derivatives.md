...
$$
\frac{\Delta y}{\Delta x} = \frac{\bigl[a(x+\Delta x) + b\bigr] - \bigl[ax + b\bigr]}{\Delta x}
$$  
...
- If you know $h'(t)$, $g'(h)$ and $f'(g)$, then the derivative of this triple composition with respect to(w.r.t.) $t$ is:  
