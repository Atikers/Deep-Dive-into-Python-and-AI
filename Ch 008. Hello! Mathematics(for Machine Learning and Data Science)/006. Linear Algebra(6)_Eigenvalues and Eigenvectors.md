...
$$
\Big\{a_1 \mathbf{v}_1 + a_2 \mathbf{v}_2 + \cdots + a_k \mathbf{v}_k \Big| a_1, a_2, \ldots, a_k \in \mathbb{R} \Big\}
$$
...
$$
2 \times \begin{pmatrix} 1 \\ 0 \end{pmatrix}
$$  
...
#### **A Simple 2D Matrix**
Let’s say $A$ sends:
- $\mathbf{i}$-hat (the vector $(1,0)$) to $(3,0)$.  
- $\mathbf{j}$-hat (the vector $(0,1)$) to $(1,2)$.
