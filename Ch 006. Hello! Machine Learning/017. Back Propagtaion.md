...
**Quiz 1:**
- **Question:** Given x=1, y=5, w₁=2, b₁=0, w₂=3, b₂=1 in a network with ReLU activations, what are a₂ and the cost J?
- **Answer:**  
  a₁ = g(2*1+0)=2  
  a₂ = g(3*2+1)=7  
  J = 1/2(7-5)² = 2
...
**Quiz 2:**
- **Question:** If increasing w₁ by a tiny ε leads to J increasing roughly by 6ε, what is this 6 representing?
- **Answer:** It’s the partial derivative ∂J/∂w₁. In other words, the gradient with respect to w₁ is 6.
