# Analyzing Stock Performance and Building a Dashboard, Visualizing by a Web Scraping
## 1) Scenario
...
with open(json_file_path) as json_file:
    Apple_info_loaded=json.load(json_file)        # Loading the information from the JSON file and printing.
