...
The symbols $\frac{\partial}{\partial w} J(w, b)$ and $\frac{\partial}{\partial b} J(w, b)$ are called **derivatives**. They come from calculus, but you don’t need to worry too much about them right now.
