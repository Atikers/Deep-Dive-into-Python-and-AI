...
$$
\frac{\partial J(\vec W, b)}{\partial w_j} = \frac{1}{m} \sum_{i=1}^{m} \left( f_{\vec W, b}(x^{(i)}) - y^{(i)} \right) x_j^{(i)}
$$
...
$$
w_j := w_j - \alpha \cdot \frac{1}{m} \sum_{i=1}^{m} \left( f_{\vec W, b}(x^{(i)}) - y^{(i)} \right) x_j^{(i)}
$$

$$
b := b - \alpha \cdot \frac{1}{m} \sum_{i=1}^{m} \left( f_{\vec W, b}(x^{(i)}) - y^{(i)} \right)
$$
...
- Gradient for each $w_j $:
  $$
  \frac{\partial J}{\partial w_j} = \frac{1}{m} \sum_{i=1}^{m} \left( f_{\vec W, b}(x^{(i)}) - y^{(i)} \right) x_j^{(i)}
  $$
  
- Gradient for $b $:
  $$
  \frac{\partial J}{\partial b} = \frac{1}{m} \sum_{i=1}^{m} \left( f_{\vec W, b}(x^{(i)}) - y^{(i)} \right)
  $$
...
$$
w := w - \alpha \cdot \frac{1}{m} \vec X^T (f_{\vec W, b}(\vec X) - y)
$$
