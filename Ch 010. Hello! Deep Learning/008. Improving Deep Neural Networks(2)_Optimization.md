...
**Initial State**: When `epoch_num` = 0, we have $\alpha = \alpha_0$ (our starting speed)

**Evolution Pattern**: As epochs increase, the denominator grows, smoothly reducing our learning rate

With $\alpha_0 = 0.2$ and `decay_rate` = 1, we see this progression:
...
**1. Exponential Decay**: $\alpha = 0.95^{\text{epoch\_num}} \times \alpha_0$
...
**2. Square Root Decay**: $\alpha = \frac{k}{\sqrt{\text{epoch\_num}}} \times \alpha_0$
